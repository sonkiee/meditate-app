...
const GetstartedSliderscreen = (props) => {
  ...
  const GetstartedSliderStyles = useMemo(
    () => GetstartedSliderStyle(Colors),
    [Colors]
  );
  ...
  const RenderItem = ({ item }) => {
    return (
      <View>
        <View
          style={[
            GetstartedSliderStyles.minstyleviewphotograpgy,
        ...
        >
          <View style={GetstartedSliderStyles.mainInnerView}>
            <View style={GetstartedSliderStyles.smallimagcenter}>
              {item.key == 1 ? (
                <LottieIcon
                  ...
                  style={[
                    GetstartedSliderStyles.imagesetus,
                    GetstartedSliderStyles.imageSlide1,
                  ]}
                />
              ) : item.key == 2 ? (
                <LottieIcon
                  ...
                  style={[
                    GetstartedSliderStyles.imagesetus,
                    GetstartedSliderStyles.imageSlide2,
                  ]}
                />
              ) : (
                <LottieIcon
                  ...
                  style={[
                    GetstartedSliderStyles.imagesetus,
                    GetstartedSliderStyles.imageSlide3,
                  ]}
                />
              )}
            </View>
            <View style={GetstartedSliderStyles.textcenterview}>
              ...
              <Text
                style={[
                  GetstartedSliderStyles.sliderText,
                  GetstartedSliderStyles.sliderTextBold,
                ]}
              >
                {t(item.boldText)}
              </Text>
