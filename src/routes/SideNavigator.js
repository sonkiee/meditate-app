...
const SideNavigator = (props) => {
  ...
  const drawerIcon = (focused, icon) => {
    return (
      <VectorIcon
        ...
        size={SF(24)}
        color={
          focused ? Colors.white_text_color : Colors.theme_backgound_second
        }
      />
    );
  };
  ...
  const drawerTitle = (focused, title) => {
    return (
      <Text
        style={{
          color: focused ? Colors.white : Colors.theme_backgound,
          fontSize: SF(18),
          fontFamily: Fonts.RobotoCondensed_Regular,
        }}
      >
  ...
  return (
    ...
    >
      ...
      />
      <Drawer.Screen
        name={RouteName.YOGA_SCREEN}
        component={YogaScreen}
        options={{
          headerTitle: (props) => (
            <AppHeader {...props} headerTitle={t("Yoga_Text")} />
          ),
          ...styleArray,
      ...
      />
      <Drawer.Screen
        name={RouteName.MEDITATION_SCREEN}
        component={MeditationScreen}
        options={{
          headerTitle: (props) => (
            <AppHeader {...props} headerTitle={t("Meditation_Text")} />
          ),
          ...styleArray,
          drawerIcon: ({ focused }) => drawerIcon(focused, "flower-tulip"),
          drawerLabel: ({ focused }) =>
            drawerTitle(focused, t("Meditation_Text")),
        }}
      />
      <Drawer.Screen
        name={RouteName.CATEGORY_SCREEN}
        component={CategoryScreen}
        options={{
          headerTitle: (props) => (
            <AppHeader {...props} headerTitle={t("Category_Text")} />
          ),
          ...styleArray,
          drawerIcon: ({ focused }) => drawerIcon(focused, "shape"),
          drawerLabel: ({ focused }) =>
            drawerTitle(focused, t("Category_Text")),
        }}
      />
      <Drawer.Screen
      ...
      />
      <Drawer.Screen
        name={RouteName.APP_SETTINGS_SCREEN}
        component={AppSettingsScreen}
        options={{
          headerTitle: (props) => (
            <AppHeader {...props} headerTitle={t("Settings_Text")} />
          ),
          ...styleArray,
          drawerIcon: ({ focused }) => drawerIcon(focused, "cog"),
          drawerLabel: ({ focused }) =>
            drawerTitle(focused, t("Settings_Text")),
        }}
      />
      <Drawer.Screen
